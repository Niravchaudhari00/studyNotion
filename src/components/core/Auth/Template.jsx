                    ...
                    loading ? (
                         ...
                         <div className='w-11/12 max-w-maxContent flex flex-col-reverse justify-between text-richblack-5 px-12 py-12 gap-y-12 md:flex-row md:gap-x-12'>
                              <div className='w-11/12 mx-auto max-w-[450px] md:mx-0 space-y-5 '>
                                   <h1 className='text-richblack-5 text-3xl font-semibold'>{title}</h1>
                                   <p className='font-semibold'>
                                        <span className='text-richblack-100 text-lg'>{description1}</span>{" "}
                                        <span className='font-edu-sa text-base text-blue-100 italic'>{description2}</span>
                                   </p>
